        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'center' }} className="about-grid">
          ...
          <div>
            ...
            <motion.p
              ...
              style={{ fontSize: '16px', lineHeight: 1.8, color: '#888', marginBottom: '20px' }}
            >
            ...
            <motion.p
              ...
              style={{ fontSize: '16px', lineHeight: 1.8, color: '#888', marginBottom: '40px' }}
            >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              {highlights.map((item, i) => (
                <motion.div
                  ...
                  style={{ padding: '24px', borderRadius: '20px', transition: 'all 0.3s ease', cursor: 'default' }}
                  onMouseEnter={e => {
                ...
                >
                  <div style={{ color: '#ff4747', marginBottom: '14px' }}>{item.icon}</div>
