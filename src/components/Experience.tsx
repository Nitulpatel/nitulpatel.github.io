...
const experiences = [
  {
    ...
    company: 'Latest Phase',
    desc: 'Leading full-scale WordPress projects with complex builds including Headless, WooCommerce, and performance optimization. Working with international clients and making key architecture decisions.',
    tags: ['WordPress', 'Headless', 'WooCommerce', 'React'],
    icon: '🚀',
  },
  {
    year: '2023 – 2026',
    ...
    company: 'Mid Phase',
    desc: 'Built custom themes and plugins while integrating payment APIs and third-party tools. Improved performance, handled debugging, and managed complete client delivery end-to-end.',
  ...
  },
  {
    ...
    company: 'Starting Phase',
    desc: 'Started with theme customization and basic plugin modifications. Mastered core PHP and WordPress fundamentals while working on UI fixes and small feature implementations.',
